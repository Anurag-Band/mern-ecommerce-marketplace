...
import { fetchAllProducts, STATUSES } from "../features/product/productSlice";
...
const LandingPage = () => {
  ...
  return (
    <div className="w-full">
      ...
      <SaleCarousel />
      <h2 className="mt-4 lg:mt-20 xl:py-5 text-2xl lg:text-4xl font-medium lg:font-semibold font-primary text-center">
        Featured Products
      </h2>
